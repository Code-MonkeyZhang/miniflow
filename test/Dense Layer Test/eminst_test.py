...
model = Model(
    [
        ...
        Dense(128, activation="relu", layer_name="L2", input_shape=256),
        Dense(64, activation="relu", layer_name="L3", input_shape=128),
        Dense(47, activation='softmax', layer_name="L4",
              input_shape=64),  # 注意：这里的输出层单元数应与标签数量一致
...
model.fit(x_train, y_train, learning_rate=5e-5,
          epochs=10, batch_size=32, b1=0.9)
